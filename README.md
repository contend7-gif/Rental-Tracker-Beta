...
- `Operations Calendar`: agenda and full month views for rent, lease, maintenance, document, recurring, planning, loan, and Smart Check dates, plus a reversible Monthly Close review for accounting and operational gaps.
...
- `Settings`: setup checklist access, optional rent and Operations Calendar desktop reminders, Real Data Mode, sample data loading, backup validation, current data status, audit log, access profile testing, updates, diagnostics, and advanced/admin controls.
