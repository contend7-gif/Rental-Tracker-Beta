...
- `Documents`: OCR-backed document inbox, guided Add bill from document flow, expense/work-order draft review, source-record links, supporting-only files, and optional AI document analysis.
