      ...
      <CardHeader className="px-4 pb-1.5 pt-3">
        <div className="flex flex-wrap items-start justify-between gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <button type="button" className="inline-flex items-center gap-1 text-xs font-medium text-teal-700 hover:underline" onClick={seeAllTransactions}>Open transactions <ArrowRight className="h-3.5 w-3.5" /></button>
          </div>
        </div>
      </CardHeader>
...
export function DashboardWorkspace({
  ...
  const actionRows = [
    openTaxReviewCount > 0 ? { Icon: AlertTriangle, label: "Tax cross-checks open", value: openTaxReviewCount, onClick: seeAllNeedsReview, actionLabel: "Open Work Queue", tone: "bg-amber-50 text-amber-800", recommendation: "Resolve open source records", detail: "The cross-check count summarizes readiness; use Work Queue to fix the underlying records." } : null,
