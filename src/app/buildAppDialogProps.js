...
export function buildAppDialogGroups(props) {
  ...
  const leaseDialogs = {
    ...
    extension: {
      ...
      document: leaseExtensionDocument,
      preview: leaseExtensionPreview,
      open: Boolean(leaseExtensionDraft),
      onClose: closeLeaseExtension,
      onChange: setLeaseExtensionDraft,
      onPdfPicker: () => extensionPdfInputRef?.current?.click(),
      onPdfInputChange: onLeaseExtensionPdfInputChange,
      onSave: saveLeaseExtension,
      onCancelExtension: cancelLeaseExtension,
      onEditExtension: (extension) => openLeaseExtension(leaseDraft, extension),
    },
    validation: {
