...
export const SETTING_CAPABILITY_BY_KEY: Partial<Record<keyof AppSettings, AccessCapability>> = {
  ...
  operationsFollowUps: "manage_operational_settings",
  monthlyCloseRecords: "reconcile_records",
  bankReconciliationRecords: "reconcile_records",
  backupIntervalDays: "manage_data_admin",
  backupRetentionCount: "manage_data_admin",
