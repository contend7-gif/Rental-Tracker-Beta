...
const COMPANION_MILEAGE_LIST_CHANNEL = "companion:mileage-list";
const COMPANION_MILEAGE_CLAIM_CHANNEL = "companion:mileage-claim";
...
contextBridge.exposeInMainWorld("desktopCompanion", {
  ...
  listMileage: () => ipcRenderer.invoke(COMPANION_MILEAGE_LIST_CHANNEL),
  claimMileage: (id) => ipcRenderer.invoke(COMPANION_MILEAGE_CLAIM_CHANNEL, { id }),
